...
public class CSMNAdapterFactory extends AdapterFactoryImpl {
	...
	protected CSMNSwitch<Adapter> modelSwitch =
		new CSMNSwitch<Adapter>() {
			@Override
			public Adapter casePseudoElement(PseudoElement object) {
				return createPseudoElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CSMN.PseudoElement <em>Pseudo Element</em>}'.
	 * <!-- begin-user-doc -->
