 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.Lifecycle.impl.ScopeConstraintImpl#getBase_NamedElement <em>Base Named Element</em>}</li>
 *   <li>{@link CSMN.Lifecycle.impl.ScopeConstraintImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link CSMN.Lifecycle.impl.ScopeConstraintImpl#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScopeConstraintImpl extends MinimalEObjectImpl.Container implements ScopeConstraint {
	...
	protected EClass eStaticClass() {
		return LifecyclePackage.Literals.SCOPE_CONSTRAINT;
	}
		...
		if (base_NamedElement != null && base_NamedElement.eIsProxy()) {
			...
			if (base_NamedElement != oldBase_NamedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LifecyclePackage.SCOPE_CONSTRAINT__BASE_NAMED_ELEMENT, oldBase_NamedElement, base_NamedElement));
			}
		}
	...
	public void setBase_NamedElement(NamedElement newBase_NamedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LifecyclePackage.SCOPE_CONSTRAINT__BASE_NAMED_ELEMENT, oldBase_NamedElement, base_NamedElement));
	}
	...
	public EList<ProductConstraint> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<ProductConstraint>(ProductConstraint.class, this, LifecyclePackage.SCOPE_CONSTRAINT__CONSTRAINT);
		}
		return constraint;
	}
	...
	public void setConstraintType(ScopeConstraintType newConstraintType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LifecyclePackage.SCOPE_CONSTRAINT__CONSTRAINT_TYPE, oldConstraintType, constraintType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LifecyclePackage.SCOPE_CONSTRAINT__CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LifecyclePackage.SCOPE_CONSTRAINT__BASE_NAMED_ELEMENT:
				if (resolve) return getBase_NamedElement();
				return basicGetBase_NamedElement();
			case LifecyclePackage.SCOPE_CONSTRAINT__CONSTRAINT:
				return getConstraint();
			case LifecyclePackage.SCOPE_CONSTRAINT__CONSTRAINT_TYPE:
