 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.Characteristics.Energy.impl.EnergyCharacteristicImpl#getBase_Relationship <em>Base Relationship</em>}</li>
 *   <li>{@link CSMN.Characteristics.Energy.impl.EnergyCharacteristicImpl#getBase_Port <em>Base Port</em>}</li>
 *   <li>{@link CSMN.Characteristics.Energy.impl.EnergyCharacteristicImpl#getEnergyType <em>Energy Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnergyCharacteristicImpl extends MinimalEObjectImpl.Container implements EnergyCharacteristic {
	...
	protected EClass eStaticClass() {
		return EnergyPackage.Literals.ENERGY_CHARACTERISTIC;
	}
		...
		if (base_Relationship != null && base_Relationship.eIsProxy()) {
			...
			if (base_Relationship != oldBase_Relationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnergyPackage.ENERGY_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
			}
		}
	...
	public void setBase_Relationship(Relationship newBase_Relationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnergyPackage.ENERGY_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
	}
	...
	public Port getBase_Port() {
		if (base_Port != null && base_Port.eIsProxy()) {
			...
			if (base_Port != oldBase_Port) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnergyPackage.ENERGY_CHARACTERISTIC__BASE_PORT, oldBase_Port, base_Port));
			}
		}
		return base_Port;
	}
	...
	public void setBase_Port(Port newBase_Port) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnergyPackage.ENERGY_CHARACTERISTIC__BASE_PORT, oldBase_Port, base_Port));
	}
	...
	public void setEnergyType(EnergyType newEnergyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnergyPackage.ENERGY_CHARACTERISTIC__ENERGY_TYPE, oldEnergyType, energyType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnergyPackage.ENERGY_CHARACTERISTIC__BASE_RELATIONSHIP:
				if (resolve) return getBase_Relationship();
				return basicGetBase_Relationship();
			case EnergyPackage.ENERGY_CHARACTERISTIC__BASE_PORT:
				if (resolve) return getBase_Port();
				return basicGetBase_Port();
			case EnergyPackage.ENERGY_CHARACTERISTIC__ENERGY_TYPE:
