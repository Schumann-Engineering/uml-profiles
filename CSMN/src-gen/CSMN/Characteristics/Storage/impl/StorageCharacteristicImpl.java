 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getBase_Port <em>Base Port</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getEncryption <em>Encryption</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getStorageFormat <em>Storage Format</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getStorageType <em>Storage Type</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getStorageName <em>Storage Name</em>}</li>
 *   <li>{@link CSMN.Characteristics.Storage.impl.StorageCharacteristicImpl#getTotalSize <em>Total Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StorageCharacteristicImpl extends MinimalEObjectImpl.Container implements StorageCharacteristic {
	...
	protected EClass eStaticClass() {
		return StoragePackage.Literals.STORAGE_CHARACTERISTIC;
	}
		...
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StoragePackage.STORAGE_CHARACTERISTIC__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public Port getBase_Port() {
		if (base_Port != null && base_Port.eIsProxy()) {
			...
			if (base_Port != oldBase_Port) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StoragePackage.STORAGE_CHARACTERISTIC__BASE_PORT, oldBase_Port, base_Port));
			}
		}
		return base_Port;
	}
	...
	public void setBase_Port(Port newBase_Port) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__BASE_PORT, oldBase_Port, base_Port));
	}
	...
	public void setEncryption(String newEncryption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__ENCRYPTION, oldEncryption, encryption));
	}
	...
	public void setStorageFormat(String newStorageFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_FORMAT, oldStorageFormat, storageFormat));
	}
	...
	public void setStorageType(StorageType newStorageType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_TYPE, oldStorageType, storageType));
	}
	...
	public void setStorageName(String newStorageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_NAME, oldStorageName, storageName));
	}
	...
	public NotificationChain basicSetTotalSize(Size_T newTotalSize, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__TOTAL_SIZE, oldTotalSize, newTotalSize);
	...
	public void setTotalSize(Size_T newTotalSize) {
		if (newTotalSize != totalSize) {
			...
			if (totalSize != null)
				msgs = ((InternalEObject)totalSize).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StoragePackage.STORAGE_CHARACTERISTIC__TOTAL_SIZE, null, msgs);
			if (newTotalSize != null)
				msgs = ((InternalEObject)newTotalSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StoragePackage.STORAGE_CHARACTERISTIC__TOTAL_SIZE, null, msgs);
			msgs = basicSetTotalSize(newTotalSize, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.STORAGE_CHARACTERISTIC__TOTAL_SIZE, newTotalSize, newTotalSize));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StoragePackage.STORAGE_CHARACTERISTIC__TOTAL_SIZE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StoragePackage.STORAGE_CHARACTERISTIC__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case StoragePackage.STORAGE_CHARACTERISTIC__BASE_PORT:
				if (resolve) return getBase_Port();
				return basicGetBase_Port();
			case StoragePackage.STORAGE_CHARACTERISTIC__ENCRYPTION:
				return getEncryption();
			case StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_FORMAT:
				return getStorageFormat();
			case StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_TYPE:
				return getStorageType();
			case StoragePackage.STORAGE_CHARACTERISTIC__STORAGE_NAME:
