...
public class SecuritySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecurityPackage.IEC62443_SECURITY_LEVEL_CHARACTERISTIC: {
