 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.PrimitiveTypes.impl.BandwidthImpl#getSize <em>Size</em>}</li>
 *   <li>{@link CSMN.PrimitiveTypes.impl.BandwidthImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BandwidthImpl extends MinimalEObjectImpl.Container implements Bandwidth {
	...
	protected EClass eStaticClass() {
		return PrimitiveTypesPackage.Literals.BANDWIDTH;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimitiveTypesPackage.BANDWIDTH__SIZE, oldSize, size));
	}
	...
	public void setUnit(SpeedUnitOfMeasurement newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimitiveTypesPackage.BANDWIDTH__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PrimitiveTypesPackage.BANDWIDTH__SIZE:
				return getSize();
			case PrimitiveTypesPackage.BANDWIDTH__UNIT:
				return getUnit();
		}
