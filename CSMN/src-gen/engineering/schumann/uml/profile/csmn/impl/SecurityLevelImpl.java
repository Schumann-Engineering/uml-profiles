 ...
 * </p>
 * <ul>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.SecurityLevelImpl#getFoundationalRequirement <em>Foundational Requirement</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.SecurityLevelImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.SecurityLevelImpl#getRational <em>Rational</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.SecurityLevelImpl#getType <em>Type</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.SecurityLevelImpl#getVector <em>Vector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecurityLevelImpl extends MinimalEObjectImpl.Container implements SecurityLevel {
	...
	protected EClass eStaticClass() {
		return CSMNPackage.Literals.SECURITY_LEVEL;
	}
	...
	public void setFoundationalRequirement(Iec62443FoundationalRequirementType newFoundationalRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__FOUNDATIONAL_REQUIREMENT, oldFoundationalRequirement, foundationalRequirement));
	}
	...
	public NotificationChain basicSetLevel(SecurityLevel newLevel, NotificationChain msgs) {
		...
		level = newLevel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__LEVEL, oldLevel, newLevel);
	...
	public void setLevel(SecurityLevel newLevel) {
		if (newLevel != level) {
			...
			if (level != null)
				msgs = ((InternalEObject)level).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CSMNPackage.SECURITY_LEVEL__LEVEL, null, msgs);
			if (newLevel != null)
				msgs = ((InternalEObject)newLevel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CSMNPackage.SECURITY_LEVEL__LEVEL, null, msgs);
			msgs = basicSetLevel(newLevel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__LEVEL, newLevel, newLevel));
	}
	...
	public void setRational(String newRational) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__RATIONAL, oldRational, rational));
	}
	...
	public void setType(Iec62443SecurityLevelType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__TYPE, oldType, type));
	}
	...
	public void setVector(String newVector) {
		...
		vector = newVector;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.SECURITY_LEVEL__VECTOR, oldVector, vector));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CSMNPackage.SECURITY_LEVEL__LEVEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSMNPackage.SECURITY_LEVEL__FOUNDATIONAL_REQUIREMENT:
				return getFoundationalRequirement();
			case CSMNPackage.SECURITY_LEVEL__LEVEL:
				return getLevel();
			case CSMNPackage.SECURITY_LEVEL__RATIONAL:
				return getRational();
			case CSMNPackage.SECURITY_LEVEL__TYPE:
				return getType();
			case CSMNPackage.SECURITY_LEVEL__VECTOR:
				return getVector();
		}
