 ...
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.MaterialCharacteristicImpl#getBase_Relationship <em>Base Relationship</em>}</li>
...
public class MaterialCharacteristicImpl extends MinimalEObjectImpl.Container implements MaterialCharacteristic {
	...
	public Relationship getBase_Relationship() {
		if (base_Relationship != null && base_Relationship.eIsProxy()) {
			...
			if (base_Relationship != oldBase_Relationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSMNPackage.MATERIAL_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
			}
		}
	...
	public void setBase_Relationship(Relationship newBase_Relationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.MATERIAL_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CSMNPackage.MATERIAL_CHARACTERISTIC__BASE_RELATIONSHIP:
