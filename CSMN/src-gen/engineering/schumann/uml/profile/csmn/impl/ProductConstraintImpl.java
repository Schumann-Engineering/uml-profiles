 ...
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.ProductConstraintImpl#getSoftwareVersion <em>Software Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductConstraintImpl extends MinimalEObjectImpl.Container implements ProductConstraint {
	...
	public EList<String> getSoftwareVersion() {
		if (softwareVersion == null) {
			softwareVersion = new EDataTypeUniqueEList<String>(String.class, this, CSMNPackage.PRODUCT_CONSTRAINT__SOFTWARE_VERSION);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSMNPackage.PRODUCT_CONSTRAINT__MODEL:
				return getModel();
			case CSMNPackage.PRODUCT_CONSTRAINT__SOFTWARE_VERSION:
