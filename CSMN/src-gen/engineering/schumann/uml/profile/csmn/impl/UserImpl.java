 ...
 * </p>
 * <ul>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.UserImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.UserImpl#getUserType <em>User Type</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.UserImpl#isUseFilledIcon <em>Use Filled Icon</em>}</li>
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.UserImpl#getBase_Actor <em>Base Actor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	protected EClass eStaticClass() {
		return CSMNPackage.Literals.USER;
	}
		...
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSMNPackage.USER__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.USER__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public void setUserType(UserType newUserType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.USER__USER_TYPE, oldUserType, userType));
	}
	...
	public void setUseFilledIcon(boolean newUseFilledIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.USER__USE_FILLED_ICON, oldUseFilledIcon, useFilledIcon));
	}
	...
	public Actor getBase_Actor() {
		if (base_Actor != null && base_Actor.eIsProxy()) {
			...
			if (base_Actor != oldBase_Actor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSMNPackage.USER__BASE_ACTOR, oldBase_Actor, base_Actor));
			}
		}
		return base_Actor;
	}
	...
	public void setBase_Actor(Actor newBase_Actor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.USER__BASE_ACTOR, oldBase_Actor, base_Actor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSMNPackage.USER__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case CSMNPackage.USER__USER_TYPE:
				return getUserType();
			case CSMNPackage.USER__USE_FILLED_ICON:
				return isUseFilledIcon();
			case CSMNPackage.USER__BASE_ACTOR:
