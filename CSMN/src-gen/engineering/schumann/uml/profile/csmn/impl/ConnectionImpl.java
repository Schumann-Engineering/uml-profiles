 ...
 *   <li>{@link engineering.schumann.uml.profile.csmn.impl.ConnectionImpl#getBase_DirectedRelationship <em>Base Directed Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionImpl extends MinimalEObjectImpl.Container implements Connection {
	...
	public DirectedRelationship getBase_DirectedRelationship() {
		if (base_DirectedRelationship != null && base_DirectedRelationship.eIsProxy()) {
			...
			if (base_DirectedRelationship != oldBase_DirectedRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSMNPackage.CONNECTION__BASE_DIRECTED_RELATIONSHIP, oldBase_DirectedRelationship, base_DirectedRelationship));
			}
		}
	...
	public void setBase_DirectedRelationship(DirectedRelationship newBase_DirectedRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSMNPackage.CONNECTION__BASE_DIRECTED_RELATIONSHIP, oldBase_DirectedRelationship, base_DirectedRelationship));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CSMNPackage.CONNECTION__PURPOSE:
				return getPurpose();
			case CSMNPackage.CONNECTION__BASE_DIRECTED_RELATIONSHIP:
