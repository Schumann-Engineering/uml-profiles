...
/**
 * This is the item provider adapter for a {@link QWiki.DomainElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainElementItemProvider extends UmlNamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.DOMAIN_ELEMENT__DOMAIN,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.DOMAIN_ELEMENT__ASSIGNED_DOMAIN,
				 true,
				 false,
				 true,
				 null,
