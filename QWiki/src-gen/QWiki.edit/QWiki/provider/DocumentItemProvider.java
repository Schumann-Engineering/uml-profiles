...
/**
 * This is the item provider adapter for a {@link QWiki.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider extends I18nDescriptiveElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Document_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Document_number_feature", "_UI_Document_type"),
				 QWikiPackage.Literals.DOCUMENT__NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addSuperseedingRelationshipPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Document_superseedingRelationship_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Document_superseedingRelationship_feature", "_UI_Document_type"),
				 QWikiPackage.Literals.DOCUMENT__SUPERSEEDING_RELATIONSHIP,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addDocumentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Document_documentType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Document_documentType_feature", "_UI_Document_type"),
				 QWikiPackage.Literals.DOCUMENT__DOCUMENT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.DOCUMENT__AUTHOR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QWikiPackage.Literals.DOCUMENT__OWNED_VERSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.DOCUMENT__OWNED_VERSION,
