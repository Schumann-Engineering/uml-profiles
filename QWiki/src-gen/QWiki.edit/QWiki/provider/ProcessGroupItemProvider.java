...
/**
 * This is the item provider adapter for a {@link QWiki.ProcessGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessGroupItemProvider extends SpiceElementItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((ProcessGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessGroup_type") :
			getString("_UI_ProcessGroup_type") + " " + label;
	}
