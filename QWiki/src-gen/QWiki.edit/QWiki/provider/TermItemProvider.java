...
/**
 * This is the item provider adapter for a {@link QWiki.Term} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TermItemProvider extends I18nNamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Term_termDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Term_termDefinition_feature", "_UI_Term_type"),
				 QWikiPackage.Literals.TERM__TERM_DEFINITION,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addExternalTermDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Term_externalTermDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Term_externalTermDefinition_feature", "_UI_Term_type"),
				 QWikiPackage.Literals.TERM__EXTERNAL_TERM_DEFINITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QWikiPackage.Literals.TERM__ACRONYM);
			childrenFeatures.add(QWikiPackage.Literals.TERM__SYNONYM);
			childrenFeatures.add(QWikiPackage.Literals.TERM__OWNED_TERM_DEFINITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.TERM__ACRONYM,
				 QWikiFactory.eINSTANCE.createI18nString()));

		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.TERM__SYNONYM,
				 QWikiFactory.eINSTANCE.createI18nString()));

		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.TERM__OWNED_TERM_DEFINITION,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == QWikiPackage.Literals.TERM__ACRONYM ||
			childFeature == QWikiPackage.Literals.TERM__SYNONYM;
