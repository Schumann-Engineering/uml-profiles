...
/**
 * This is the item provider adapter for a {@link QWiki.BasePractise} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.BASE_PRACTISE__FACILITATED_OUTCOME,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.BASE_PRACTISE__FACILITATED_WORK_PRODUCT,
				 true,
				 false,
				 true,
				 null,
