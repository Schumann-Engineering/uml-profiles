...
/**
 * This is the item provider adapter for a {@link QWiki.QWikiRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QWikiRelationshipItemProvider extends DirectedRelationshipItemProvider {
	/**
	 ...
	 * @generated
	 */
	public QWikiRelationshipItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addRelationshipTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QWikiRelationship_relationshipType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QWikiRelationship_relationshipType_feature", "_UI_QWikiRelationship_type"),
				 QWikiPackage.Literals.QWIKI_RELATIONSHIP__RELATIONSHIP_TYPE,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((QWikiRelationship)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_QWikiRelationship_type") :
			getString("_UI_QWikiRelationship_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QWikiRelationship.class)) {
