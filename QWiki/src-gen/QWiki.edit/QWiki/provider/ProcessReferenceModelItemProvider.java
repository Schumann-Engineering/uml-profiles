...
/**
 * This is the item provider adapter for a {@link QWiki.ProcessReferenceModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessReferenceModelItemProvider extends I18nDescriptiveElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.PROCESS_REFERENCE_MODEL__IS_NON_STANDARD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.PROCESS_REFERENCE_MODEL__PRM_DOMAIN,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QWikiPackage.Literals.PROCESS_REFERENCE_MODEL__OWNED_SPICE_ELEMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.PROCESS_REFERENCE_MODEL__OWNED_SPICE_ELEMENT,
