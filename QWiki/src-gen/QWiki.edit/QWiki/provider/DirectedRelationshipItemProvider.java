...
/**
 * This is the item provider adapter for a {@link QWiki.DirectedRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectedRelationshipItemProvider extends RelationshipItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.DIRECTED_RELATIONSHIP__TARGET,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.DIRECTED_RELATIONSHIP__SOURCE,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((DirectedRelationship)object).getUuid();
