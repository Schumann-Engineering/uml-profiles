...
/**
 * This is the item provider adapter for a {@link QWiki.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider extends TaggedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_uuid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_uuid_feature", "_UI_ModelElement_type"),
				 QWikiPackage.Literals.MODEL_ELEMENT__UUID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ModelElement)object).getUuid();
