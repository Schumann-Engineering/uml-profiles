...
/**
 * This is the item provider adapter for a {@link QWiki.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider extends TaggedElementItemProvider {
	/**
	...
	protected void addAssignedDomainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_assignedDomain_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_assignedDomain_feature", "_UI_NamedElement_type"),
				 QWikiPackage.Literals.NAMED_ELEMENT__ASSIGNED_DOMAIN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDomainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_domain_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_domain_feature", "_UI_NamedElement_type"),
				 QWikiPackage.Literals.NAMED_ELEMENT__DOMAIN,
				 false,
				 false,
				 false,
				 null,
