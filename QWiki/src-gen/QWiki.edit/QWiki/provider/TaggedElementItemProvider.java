...
/**
 * This is the item provider adapter for a {@link QWiki.TaggedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaggedElementItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaggedElement_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaggedElement_tag_feature", "_UI_TaggedElement_type"),
				 QWikiPackage.Literals.TAGGED_ELEMENT__TAG,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QWikiPackage.Literals.TAGGED_ELEMENT__CUSTOM_PROPERTY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.TAGGED_ELEMENT__CUSTOM_PROPERTY,
				 QWikiFactory.eINSTANCE.createI18nKeyedString()));
	}
