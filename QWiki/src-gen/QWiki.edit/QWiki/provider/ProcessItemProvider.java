...
/**
 * This is the item provider adapter for a {@link QWiki.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends SpiceElementItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFacilitatingWorkProductPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Facilitating Work Product feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFacilitatingWorkProductPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.PROCESS__FACILITATING_WORK_PRODUCT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QWikiPackage.Literals.PROCESS__FACILITATED_WORK_PRODUCT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QWikiPackage.Literals.PROCESS__OWNED_OUTCOME);
			childrenFeatures.add(QWikiPackage.Literals.PROCESS__OWNED_BASE_PRACTISE);
		}
	...
	public String getText(Object object) {
		String label = ((QWiki.Process)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.PROCESS__OWNED_OUTCOME,
				 QWikiFactory.eINSTANCE.createOutcome()));

		newChildDescriptors.add
			(createChildParameter
				(QWikiPackage.Literals.PROCESS__OWNED_BASE_PRACTISE,
