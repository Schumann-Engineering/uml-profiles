...
/**
 * This is the item provider adapter for a {@link QWiki.Kernel.QWikiNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QWikiNamedElementItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public QWikiNamedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((QWikiNamedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QWikiNamedElement_type") :
			getString("_UI_QWikiNamedElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QWikiNamedElement.class)) {
