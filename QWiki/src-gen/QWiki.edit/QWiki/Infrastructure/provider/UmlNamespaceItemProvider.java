...
/**
 * This is the item provider adapter for a {@link QWiki.Infrastructure.UmlNamespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UmlNamespaceItemProvider extends I18nDescriptiveElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfrastructurePackage.Literals.UML_NAMESPACE__OWNED_MEMBER,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfrastructurePackage.Literals.UML_NAMESPACE__MEMBER,
				 false,
				 false,
				 false,
				 null,
