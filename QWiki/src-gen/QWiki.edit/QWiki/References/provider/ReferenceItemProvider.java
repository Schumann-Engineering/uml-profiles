...
/**
 * This is the item provider adapter for a {@link QWiki.References.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider extends QWikiContainerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_number_feature", "_UI_Reference_type"),
				 ReferencesPackage.Literals.REFERENCE__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReferencesPackage.Literals.REFERENCE__REFERENCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAuthorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_author_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_author_feature", "_UI_Reference_type"),
				 ReferencesPackage.Literals.REFERENCE__AUTHOR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReferencesPackage.Literals.REFERENCE__OWNED_VERSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReferencesPackage.Literals.REFERENCE__OWNED_VERSION,
