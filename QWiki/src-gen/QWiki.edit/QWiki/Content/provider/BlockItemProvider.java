...
/**
 * This is the item provider adapter for a {@link QWiki.Content.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider extends ContentContainerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Block_blockType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Block_blockType_feature", "_UI_Block_type"),
				 ContentPackage.Literals.BLOCK__BLOCK_TYPE,
				 true,
				 false,
				 false,
