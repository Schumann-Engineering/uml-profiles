...
/**
 * This is the item provider adapter for a {@link QWiki.Content.Panel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PanelItemProvider extends ContentContainerItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPanelTypePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addPanelTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Panel_panelType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Panel_panelType_feature", "_UI_Panel_type"),
				 ContentPackage.Literals.PANEL__PANEL_TYPE,
				 true,
				 false,
				 false,
