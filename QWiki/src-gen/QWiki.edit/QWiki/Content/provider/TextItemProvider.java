...
/**
 * This is the item provider adapter for a {@link QWiki.Content.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider extends ContentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_textType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_textType_feature", "_UI_Text_type"),
				 ContentPackage.Literals.TEXT__TEXT_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ContentPackage.Literals.TEXT__BODY);
		}
	...
	public String getText(Object object) {
		String label = ((Text)object).getUuid();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ContentPackage.Literals.TEXT__BODY,
