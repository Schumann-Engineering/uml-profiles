 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.impl.QWikiRelationshipTypeImpl#getRelationship <em>Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class QWikiRelationshipTypeImpl extends QWikiNamedElementImpl implements QWikiRelationshipType {
	...
	protected EClass eStaticClass() {
		return QWikiPackage.Literals.QWIKI_RELATIONSHIP_TYPE;
	}
	...
	public EList<QWikiRelationship> getRelationship() {
		return new DerivedUnionEObjectEList<QWikiRelationship>(QWikiRelationship.class, this, QWikiPackage.QWIKI_RELATIONSHIP_TYPE__RELATIONSHIP, null);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QWikiPackage.QWIKI_RELATIONSHIP_TYPE__RELATIONSHIP:
