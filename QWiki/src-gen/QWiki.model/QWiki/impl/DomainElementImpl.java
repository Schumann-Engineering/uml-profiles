 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.impl.DomainElementImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link QWiki.impl.DomainElementImpl#getAssignedDomain <em>Assigned Domain</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DomainElementImpl extends UmlNamedElementImpl implements DomainElement {
	/**
	...
	protected EClass eStaticClass() {
		return QWikiPackage.Literals.DOMAIN_ELEMENT;
	}
	...
	public Domain basicGetDomain() {
		if (eIsSet(QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN)) {
		...
		if (assignedDomain != null && assignedDomain.eIsProxy()) {
			...
			if (assignedDomain != oldAssignedDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN, oldAssignedDomain, assignedDomain));
			}
		}
	...
	public NotificationChain basicSetAssignedDomain(Domain newAssignedDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN, oldAssignedDomain, newAssignedDomain);
	...
	public void setAssignedDomain(Domain newAssignedDomain) {
		if (newAssignedDomain != assignedDomain) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN, newAssignedDomain, newAssignedDomain));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN:
				if (assignedDomain != null)
					msgs = ((InternalEObject)assignedDomain).eInverseRemove(this, QWikiPackage.DOMAIN__DOMAIN_ELEMENT, Domain.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QWikiPackage.DOMAIN_ELEMENT__DOMAIN:
	...
	public boolean isSetDomain() {
		return eIsSet(QWikiPackage.DOMAIN_ELEMENT__ASSIGNED_DOMAIN);
	}
