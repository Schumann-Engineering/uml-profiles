 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.impl.UmlPackageImpl#getOwnedMember <em>Owned Member</em>}</li>
 *   <li>{@link QWiki.impl.UmlPackageImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link QWiki.impl.UmlPackageImpl#getPackagedElement <em>Packaged Element</em>}</li>
 *   <li>{@link QWiki.impl.UmlPackageImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link QWiki.impl.UmlPackageImpl#getNestingPackage <em>Nesting Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UmlPackageImpl extends UmlNamespaceImpl implements UmlPackage {
	...
	protected EClass eStaticClass() {
		return QWikiPackage.Literals.UML_PACKAGE;
	}
	...
	public EList<UmlNamedElement> getOwnedMember() {
		return new DerivedUnionEObjectEList<UmlNamedElement>(UmlNamedElement.class, this, QWikiPackage.UML_PACKAGE__OWNED_MEMBER, OWNED_MEMBER_ESUBSETS);
	}
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] {QWikiPackage.UML_PACKAGE__PACKAGED_ELEMENT};
	...
	public EList<UmlPackageableElement> getPackagedElement() {
		if (packagedElement == null) {
			packagedElement = new EObjectContainmentEList<UmlPackageableElement>(UmlPackageableElement.class, this, QWikiPackage.UML_PACKAGE__PACKAGED_ELEMENT);
		}
	 ...
	 * @ordered
	 */
	protected static final int[] NESTED_PACKAGE_ESUPERSETS = new int[] {QWikiPackage.UML_PACKAGE__PACKAGED_ELEMENT};
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate MUST_BE_OWNED__EINVOCATION_DELEGATE = ((EOperation.Internal)QWikiPackage.Literals.UML_ELEMENT___MUST_BE_OWNED).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QWikiPackage.UML_PACKAGE___MUST_BE_OWNED:
				return mustBeOwned();
		}
	...
	public boolean isSetOwnedMember() {
		return super.isSetOwnedMember()
			|| eIsSet(QWikiPackage.UML_PACKAGE__PACKAGED_ELEMENT);
	}
	...
	public boolean isSetNamespace() {
		return super.isSetNamespace()
			|| eIsSet(QWikiPackage.UML_PACKAGE__NESTING_PACKAGE);
	}
