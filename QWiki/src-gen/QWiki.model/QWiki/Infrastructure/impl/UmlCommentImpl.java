 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.Infrastructure.impl.UmlCommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link QWiki.Infrastructure.impl.UmlCommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UmlCommentImpl extends UmlElementImpl implements UmlComment {
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.UML_COMMENT;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.UML_COMMENT__BODY, oldBody, body));
	}
	...
	public EList<UmlElement> getAnnotatedElement() {
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList<UmlElement>(UmlElement.class, this, InfrastructurePackage.UML_COMMENT__ANNOTATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfrastructurePackage.UML_COMMENT__BODY:
				return getBody();
			case InfrastructurePackage.UML_COMMENT__ANNOTATED_ELEMENT:
