 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.Infrastructure.impl.UmlRelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UmlRelationshipImpl extends UmlElementImpl implements UmlRelationship {
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.UML_RELATIONSHIP;
	}
	...
	public EList<UmlElement> getRelatedElement() {
		return new DerivedUnionEObjectEList<UmlElement>(UmlElement.class, this, InfrastructurePackage.UML_RELATIONSHIP__RELATED_ELEMENT, null);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfrastructurePackage.UML_RELATIONSHIP__RELATED_ELEMENT:
