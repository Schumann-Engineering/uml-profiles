...
public class GlossarySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GlossaryPackage.GLOSSARY_TERM_DEFINITION: {
				...
				if (result == null) result = caseElement(glossaryTermDefinition);
				if (result == null) result = caseEModelElement(glossaryTermDefinition);
			...
			case GlossaryPackage.GLOSSARY_TERM: {
				...
				if (result == null) result = caseElement(glossaryTerm);
				if (result == null) result = caseEModelElement(glossaryTerm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseGlossaryTermDefinition(GlossaryTermDefinition object) {
		return null;
	}
