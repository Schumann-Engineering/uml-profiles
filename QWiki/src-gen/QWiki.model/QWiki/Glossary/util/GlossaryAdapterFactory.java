...
public class GlossaryAdapterFactory extends AdapterFactoryImpl {
	...
	protected GlossarySwitch<Adapter> modelSwitch =
		new GlossarySwitch<Adapter>() {
			@Override
			public Adapter caseGlossaryTermDefinition(GlossaryTermDefinition object) {
				return createGlossaryTermDefinitionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Glossary.GlossaryTermDefinition <em>Term Definition</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGlossaryTermDefinitionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Glossary.GlossaryTerm <em>Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
