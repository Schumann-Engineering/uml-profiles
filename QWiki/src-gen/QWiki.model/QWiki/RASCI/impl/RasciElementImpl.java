 ...
 *   <li>{@link QWiki.RASCI.impl.RasciElementImpl#getSupportingRole <em>Supporting Role</em>}</li>
 *   <li>{@link QWiki.RASCI.impl.RasciElementImpl#getConsultingRole <em>Consulting Role</em>}</li>
...
public abstract class RasciElementImpl extends I18nDescriptiveElementImpl implements RasciElement {
	...
	public EList<Role> getSupportingRole() {
		if (supportingRole == null) {
			supportingRole = new EObjectWithInverseResolvingEList.ManyInverse<Role>(Role.class, this, RASCIPackage.RASCI_ELEMENT__SUPPORTING_ROLE, RASCIPackage.ROLE__SUPPORTING_ELEMENT);
		}
	...
	public EList<Role> getConsultingRole() {
		if (consultingRole == null) {
			consultingRole = new EObjectWithInverseResolvingEList.ManyInverse<Role>(Role.class, this, RASCIPackage.RASCI_ELEMENT__CONSULTING_ROLE, RASCIPackage.ROLE__CONSULTING_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RASCIPackage.RASCI_ELEMENT__SUPPORTING_ROLE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getSupportingRole()).basicAdd(otherEnd, msgs);
			case RASCIPackage.RASCI_ELEMENT__CONSULTING_ROLE:
