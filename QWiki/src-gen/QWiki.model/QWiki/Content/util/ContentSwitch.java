	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContentPackage.CONTENT: {
				...
				if (result == null) result = caseQWikiElement(content);
				if (result == null) result = caseElement(content);
				if (result == null) result = caseEModelElement(content);
			...
			case ContentPackage.CONTENT_CONTAINER: {
				...
				if (result == null) result = caseNamespace(contentContainer);
				if (result == null) result = caseContent(contentContainer);
				if (result == null) result = caseNamedElement(contentContainer);
				if (result == null) result = caseQWikiElement(contentContainer);
				if (result == null) result = caseElement(contentContainer);
				if (result == null) result = caseEModelElement(contentContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentPackage.LAYOUT: {
				...
				if (result == null) result = caseContent(layout);
				if (result == null) result = caseQWikiElement(layout);
				if (result == null) result = caseElement(layout);
				if (result == null) result = caseEModelElement(layout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentPackage.TEXT: {
				...
				if (result == null) result = caseQWikiElement(text);
				if (result == null) result = caseElement(text);
				if (result == null) result = caseEModelElement(text);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentPackage.BLOCK: {
				...
				if (result == null) result = caseContentContainer(block);
				...
				if (result == null) result = caseQWikiElement(block);
			...
			case ContentPackage.PANEL: {
				...
				if (result == null) result = caseContentContainer(panel);
				if (result == null) result = caseNamespace(panel);
				if (result == null) result = caseContent(panel);
				if (result == null) result = caseNamedElement(panel);
				if (result == null) result = caseQWikiElement(panel);
				if (result == null) result = caseElement(panel);
				if (result == null) result = caseEModelElement(panel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentPackage.SECTION: {
				...
				if (result == null) result = caseContent(section);
