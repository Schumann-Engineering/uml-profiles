...
public class ReferencesFactoryImpl extends EFactoryImpl implements ReferencesFactory {
	 ...
	 * @generated
	 */
	public ReferenceVersionType createReferenceVersionTypeFromString(EDataType eDataType, String initialValue) {
		ReferenceVersionType result = ReferenceVersionType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertReferenceVersionTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
