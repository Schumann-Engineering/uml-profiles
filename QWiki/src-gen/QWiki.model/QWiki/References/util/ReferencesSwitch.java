...
public class ReferencesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReferencesPackage.AUTHOR: {
				...
				if (result == null) result = caseQWikiNamedElement(author);
				if (result == null) result = caseNamedElement(author);
				if (result == null) result = caseQWikiElement(author);
				if (result == null) result = caseElement(author);
				if (result == null) result = caseEModelElement(author);
			...
			case ReferencesPackage.REFERENCE_VERSION: {
				ReferenceVersion referenceVersion = (ReferenceVersion)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reference Version</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reference Version</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReferenceVersion(ReferenceVersion object) {
		return null;
	}
