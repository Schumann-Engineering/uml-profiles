 ...
 * @generated
 */
public class _PackageImpl extends EPackageImpl implements _Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see QWiki.I18N._Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private _PackageImpl() {
		super(eNS_URI, _Factory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link _Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static _Package init() {
		if (isInited) return (_Package)EPackage.Registry.INSTANCE.getEPackage(_Package.eNS_URI);

		// Obtain or create and register package
		Object registered_Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		_PackageImpl the_Package = registered_Package instanceof _PackageImpl ? (_PackageImpl)registered_Package : new _PackageImpl();
		...
		the_Package.createPackageContents();
		...
		the_Package.initializePackageContents();
		...
		EPackage.Registry.INSTANCE.put(_Package.eNS_URI, the_Package);
		return the_Package;
	}
	 ...
	 */
	@Override
	public _Factory get_Factory() {
		return (_Factory)getEFactoryInstance();
	}
