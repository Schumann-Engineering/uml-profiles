...
public class RelationshipsAdapterFactory extends AdapterFactoryImpl {
	...
	protected RelationshipsSwitch<Adapter> modelSwitch =
		new RelationshipsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDO_NOT_USE_SuperseedingRelationship(DO_NOT_USE_SuperseedingRelationship object) {
				return createDO_NOT_USE_SuperseedingRelationshipAdapter();
			}
			@Override
			public Adapter caseDO_NOT_USE_ModelElement(DO_NOT_USE_ModelElement object) {
				return createDO_NOT_USE_ModelElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Kernel.Relationships.DO_NOT_USE_Relationship <em>DO NOT USE Relationship</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Kernel.Relationships.DO_NOT_USE_RelationshipType <em>DO NOT USE Relationship Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Kernel.Relationships.DO_NOT_USE_SuperseedingRelationship <em>DO NOT USE Superseeding Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link QWiki.Kernel.Relationships.DO_NOT_USE_ModelElement <em>DO NOT USE Model Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDO_NOT_USE_ModelElementAdapter() {
		return null;
	}
