 ...
 * @generated
 */
public class RelationshipsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelationshipsPackage.DO_NOT_USE_RELATIONSHIP: {
			...
			case RelationshipsPackage.DO_NOT_USE_RELATIONSHIP_TYPE: {
				...
				if (result == null) result = caseQWikiNamedElement(dO_NOT_USE_RelationshipType);
				if (result == null) result = caseNamedElement(dO_NOT_USE_RelationshipType);
				if (result == null) result = caseQWikiElement(dO_NOT_USE_RelationshipType);
				if (result == null) result = caseElement(dO_NOT_USE_RelationshipType);
				if (result == null) result = caseEModelElement(dO_NOT_USE_RelationshipType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationshipsPackage.DO_NOT_USE_SUPERSEEDING_RELATIONSHIP: {
				DO_NOT_USE_SuperseedingRelationship dO_NOT_USE_SuperseedingRelationship = (DO_NOT_USE_SuperseedingRelationship)theEObject;
				T result = caseDO_NOT_USE_SuperseedingRelationship(dO_NOT_USE_SuperseedingRelationship);
				if (result == null) result = caseDirectedRelationship(dO_NOT_USE_SuperseedingRelationship);
				if (result == null) result = caseRelationship(dO_NOT_USE_SuperseedingRelationship);
				if (result == null) result = caseElement(dO_NOT_USE_SuperseedingRelationship);
				if (result == null) result = caseEModelElement(dO_NOT_USE_SuperseedingRelationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationshipsPackage.DO_NOT_USE_MODEL_ELEMENT: {
				DO_NOT_USE_ModelElement dO_NOT_USE_ModelElement = (DO_NOT_USE_ModelElement)theEObject;
				T result = caseDO_NOT_USE_ModelElement(dO_NOT_USE_ModelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DO NOT USE Superseeding Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DO NOT USE Superseeding Relationship</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDO_NOT_USE_SuperseedingRelationship(DO_NOT_USE_SuperseedingRelationship object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>DO NOT USE Model Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DO NOT USE Model Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDO_NOT_USE_ModelElement(DO_NOT_USE_ModelElement object) {
		return null;
	}
