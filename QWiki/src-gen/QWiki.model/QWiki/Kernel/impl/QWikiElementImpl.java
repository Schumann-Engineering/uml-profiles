...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>QWiki Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link QWiki.Kernel.impl.QWikiElementImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link QWiki.Kernel.impl.QWikiElementImpl#getCustomProperty <em>Custom Property</em>}</li>
 *   <li>{@link QWiki.Kernel.impl.QWikiElementImpl#getTag <em>Tag</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class QWikiElementImpl extends ElementImpl implements QWikiElement {
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.QWIKI_ELEMENT;
	}
	...
	public void setUuid(String newUuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.QWIKI_ELEMENT__UUID, oldUuid, uuid));
	}
	...
	public EList<I18nKeyedString> getCustomProperty() {
		if (customProperty == null) {
			customProperty = new EObjectContainmentEList<I18nKeyedString>(I18nKeyedString.class, this, KernelPackage.QWIKI_ELEMENT__CUSTOM_PROPERTY);
		}
	...
	public EList<String> getTag() {
		if (tag == null) {
			tag = new EDataTypeUniqueEList<String>(String.class, this, KernelPackage.QWIKI_ELEMENT__TAG);
		}
		return tag;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case KernelPackage.QWIKI_ELEMENT___OID_BASIC:
				return oidBasic();
		}
