...
import QWiki.Infrastructure.impl.UmlDirectedRelationshipImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link QWiki.Kernel.impl.SuperseedingRelationshipImpl#getSuperseedingType <em>Superseeding Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SuperseedingRelationshipImpl extends UmlDirectedRelationshipImpl implements SuperseedingRelationship {
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.SUPERSEEDING_RELATIONSHIP;
	}
	...
	public void setSuperseedingType(SuperseedingType newSuperseedingType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.SUPERSEEDING_RELATIONSHIP__SUPERSEEDING_TYPE, oldSuperseedingType, superseedingType));
	}
