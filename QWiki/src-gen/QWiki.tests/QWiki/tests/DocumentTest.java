...
public class DocumentTest extends I18nDescriptiveElementTest {
	...
	protected void setUp() throws Exception {
		setFixture(QWikiFactory.eINSTANCE.createDocument());
	}
	...
	/**
	 * Tests the '{@link QWiki.Document#getSuperseedingRelationship() <em>Superseeding Relationship</em>}' feature getter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
