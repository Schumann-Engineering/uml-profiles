...
/**
 * This is the item provider adapter for a {@link engineering.schumann.uml.model.sbom.DescribedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DescribedElement_summary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DescribedElement_summary_feature", "_UI_DescribedElement_type"),
				 SBOMPackage.Literals.DESCRIBED_ELEMENT__SUMMARY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SBOMPackage.Literals.DESCRIBED_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLicensePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DescribedElement_license_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DescribedElement_license_feature", "_UI_DescribedElement_type"),
				 SBOMPackage.Literals.DESCRIBED_ELEMENT__LICENSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
