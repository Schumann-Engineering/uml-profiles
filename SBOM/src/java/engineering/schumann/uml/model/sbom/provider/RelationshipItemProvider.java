...
public class RelationshipItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SBOMPackage.Literals.RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SBOMPackage.Literals.RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SBOMPackage.Literals.RELATIONSHIP__TYPE,
				 true,
				 false,
				 false,
	...
	public ResourceLocator getResourceLocator() {
		return SbomEditPlugin.INSTANCE;
	}
