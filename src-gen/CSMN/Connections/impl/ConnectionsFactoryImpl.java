...
public class ConnectionsFactoryImpl extends EFactoryImpl implements ConnectionsFactory {
	...
	public static ConnectionsFactory init() {
		try {
			ConnectionsFactory theConnectionsFactory = (ConnectionsFactory)EPackage.Registry.INSTANCE.getEFactory(ConnectionsPackage.eNS_URI);
			if (theConnectionsFactory != null) {
				return theConnectionsFactory;
			}
		}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ConnectionsPackage.CONNECTION: return createConnection();
			default:
