 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getPresentation <em>Presentation</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getSession <em>Session</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getTransport <em>Transport</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getDataLink <em>Data Link</em>}</li>
 *   <li>{@link CSMN.Characteristics.Flow.impl.OsiCharacteristicImpl#getPhysical <em>Physical</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OsiCharacteristicImpl extends FlowCharacteristicImpl implements OsiCharacteristic {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.OSI_CHARACTERISTIC;
	}
	...
	public void setApplication(String newApplication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__APPLICATION, oldApplication, application));
	}
	...
	public void setPresentation(String newPresentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__PRESENTATION, oldPresentation, presentation));
	}
	...
	public void setSession(String newSession) {
		...
		session = newSession;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__SESSION, oldSession, session));
	}
	...
	public void setTransport(String newTransport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__TRANSPORT, oldTransport, transport));
	}
	...
	public void setNetwork(String newNetwork) {
		...
		network = newNetwork;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__NETWORK, oldNetwork, network));
	}
	...
	public void setDataLink(String newDataLink) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__DATA_LINK, oldDataLink, dataLink));
	}
	...
	public void setPhysical(String newPhysical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OSI_CHARACTERISTIC__PHYSICAL, oldPhysical, physical));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowPackage.OSI_CHARACTERISTIC__APPLICATION:
				return getApplication();
			case FlowPackage.OSI_CHARACTERISTIC__PRESENTATION:
				return getPresentation();
			case FlowPackage.OSI_CHARACTERISTIC__SESSION:
				return getSession();
			case FlowPackage.OSI_CHARACTERISTIC__TRANSPORT:
				return getTransport();
			case FlowPackage.OSI_CHARACTERISTIC__NETWORK:
				return getNetwork();
			case FlowPackage.OSI_CHARACTERISTIC__DATA_LINK:
				return getDataLink();
			case FlowPackage.OSI_CHARACTERISTIC__PHYSICAL:
				return getPhysical();
		}
