 ...
 * </p>
 * <ul>
 *   <li>{@link CSMN.Characteristics.Flow.impl.FlowCharacteristicImpl#getBase_Relationship <em>Base Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FlowCharacteristicImpl extends MinimalEObjectImpl.Container implements FlowCharacteristic {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.FLOW_CHARACTERISTIC;
	}
		...
		if (base_Relationship != null && base_Relationship.eIsProxy()) {
			...
			if (base_Relationship != oldBase_Relationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FlowPackage.FLOW_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
			}
		}
	...
	public void setBase_Relationship(Relationship newBase_Relationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.FLOW_CHARACTERISTIC__BASE_RELATIONSHIP, oldBase_Relationship, base_Relationship));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowPackage.FLOW_CHARACTERISTIC__BASE_RELATIONSHIP:
